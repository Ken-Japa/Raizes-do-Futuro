...
import { Droplets, Sprout, RefreshCcw, Leaf, Calendar, ArrowRight } from "lucide-react";
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <Card className="lg:col-span-1 border-cyan-500/20 bg-card/50">
                    ...
                    <CardContent className="space-y-8">
                        ...
                        <div className="p-4 rounded-lg bg-cyan-500/5 border border-cyan-500/10 text-sm">
                            <div className="flex items-start gap-3">
                                <RefreshCcw className="w-5 h-5 text-cyan-500 mt-1" />
                                <div>
                                    <span className="font-bold block mb-1">Ciclo Fechado</span>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="flex items-baseline gap-2">
                                    ...
                                    <span className="text-sm font-medium text-muted-foreground">vs Agricultura Tradicional</span>
                                </div>
                                <p className="text-xs opacity-70 mt-1">Sistema de recirculação contínua</p>
                            </CardContent>
                        </Card>
                    </div>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid md:grid-cols-2 gap-8">
                                <div>
                                    ...
                                    <div className="text-2xl font-bold">{lettuceHeadsPerMonth.toFixed(0)} <span className="text-sm font-normal">unidades (Alface/Rúcula)</span></div>
                                </div>
                                <div>
                                    <h4 className="text-sm font-medium mb-1 text-muted-foreground">Receita Bruta Adicional</h4>
                                    <div className="text-2xl font-bold text-green-600">{formatCurrency(monthlyRevenue)} <span className="text-sm font-normal">/ mês</span></div>
                                </div>
                            </div>

                            <div className="pt-4 border-t border-green-500/10 text-xs text-muted-foreground">
                                *Cálculo base para folhosas de ciclo rápido (30-40 dias). Frutíferas (Tomate/Pimentão) exigem maior densidade de nutrientes.
                            </div>
                        </CardContent>
                    </Card>
